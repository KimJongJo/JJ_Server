                ...
                <div id="tool">
                    <div id="inner">
                        <table>
                            <tr>
                                <th>아이디</th>
                                <td><input type="text" class="btn" name="inputId"></td>
                            </tr>
                            <tr>
                                <th>비밀번호</th>
                                <td><input type="password" class="btn" name="inputPw"></td>
                            </tr>
                            <tr>
                                <th>비밀번호 확인</th>
                                <td><input type="password" class="btn" name="inputPw2"></td>
                            </tr>
                            <tr>
                                <th>이름(닉네임)</th>
                                <td><input type="text" class="btn" name="inputName"></td>
                            </tr>
                        </table>
                    </div>
