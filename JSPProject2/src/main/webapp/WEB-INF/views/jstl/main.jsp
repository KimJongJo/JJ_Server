...
<body>
	...
	<c:set var="temp" value="<h1>JSTL테스트</h1>"/>
	...
	<%-- 현재 경로 : localhost:8080/jstl/main 
		목포 경로 : localhost:8080/jstl/student/selectAll
	--%>
	...
	<%-- 현재 경로 : localhost:8080/jstl/main 
		목포 경로 : localhost:8080/jstl/student/selectArch
	--%>
	...
	<br>
	<%-- 현재 경로 : localhost:8080/jstl/main 
		목포 경로 : localhost:8080/jstl/student/selectOne
	--%>
